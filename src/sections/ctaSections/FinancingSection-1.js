 ...
 * @example <FinancingSection />
 */
const FinancingSection1 = (className) => {
  /**
  ...
  const data = useStaticQuery(graphql`
    query {
      carsImage: file(relativePath: { eq: "prequalify.png" }) {
        childImageSharp {
  ...
  return (
    <CtaTemplate
      ...
      imageAlt="prequalify for financing"
      heading="Get Prequalified for Financing"
      description="We offer financing options for all credit types. Get prequalified today!"
      link="/financing"
      className={className}
    />
  )
...
export default FinancingSection1
